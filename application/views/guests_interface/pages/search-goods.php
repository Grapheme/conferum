	...
	<div class="wrapper">
		<div class="main clearfix">
			...
			<div class="main-container">
			 ...
			 <div class="outer-wrapper top search-goods-wr">
				<section class="find-goods clearfix">
					<header>
						<h1>Подбор средств</h1>
					</header>
					<div class="search-goods">
						<?php $this->load->view('guests_interface/forms/search-products');?>
					</div>
				</section>
			</div>
		<?php if($this->input->get('search') !== FALSE && $this->input->get('search') != ''):?>
			<div class="main clearfix">
					...
					<?php for($i=0;$i<count($products);$i++): ?>
						<li class="typical-event-list-item clearfix">
							...
							<div class="event-desc">
								...
								<div class="event-short-info search-goods-it" data-product="<?=$products[$i]['id'];?>">

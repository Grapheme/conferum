...
class Products extends MY_Model {
    ...
    function getSubCategoriesTitlesByProductID($productID, $select_all = FALSE) {
    ...
    function setFoundProducts($string) {
        ...
        $match = array('page_title' => $string, 'page_description' => $string, 'page_h1' => $string, 'title' => $string,
            'destination' => $string, 'advantages' => $string, 'applying' => $string, 'description' => $string);
